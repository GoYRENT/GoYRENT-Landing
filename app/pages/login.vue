  ...
  <UCard class="max-w-sm w-full bg-white/75 dark:bg-white/5 backdrop-blur">
    ...
    >
      <template #description>
        ¿No tienes una cuenta? <NuxtLink to="/signup" class="text-primary font-medium">Registrarme</NuxtLink>
    
      </template>

      <template #password-hint>
        <NuxtLink to="/" class="text-primary font-medium">¿Olvidaste la contraseña?</NuxtLink>
      </template>

      <template #footer>
        Al iniciar sesión, aceptas la <NuxtLink to="/enterprise/privacy-policy" class="text-primary font-medium"> política de privacidad</NuxtLink> y los <NuxtLink to="/enterprise/agreement" class="text-primary font-medium">términos y condiciones</NuxtLink> de GoYRENT.
      </template>
    </UAuthForm>
  </UCard>
</template>
